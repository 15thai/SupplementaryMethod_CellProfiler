...
def process_group_of_measurements(working_dir, output_dir):
    ...
    return print(working_dir, "is Done")
...
def main():
    ...
    working_dir = "/media/anhpeo/DATA/Study/output/38034_Original_500"
    output_folder ="/media/anhpeo/DATA/Study/output/38034_Original_500_Auto"
...
def get_list_of_valid_folder(folder):
    valid_folders = []
    for i in os.listdir(folder):
        if os.path.isfile(os.path.join(folder, i, 'MyExpt_next_groupNuclei.csv')):
            valid_folders.append(os.path.join(folder, i))
